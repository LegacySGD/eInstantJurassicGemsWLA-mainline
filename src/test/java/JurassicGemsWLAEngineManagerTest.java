...
public class JurassicGemsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JurassicGemsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/JurassicGemsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JurassicGemsWLAIW/InitOutcome.xml").getDocumentElement();
